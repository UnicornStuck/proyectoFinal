...
<body>
    ...
    <div class="InfoContainer">
        ...
        <div class="user">
            <form action="/Machine/validateCredential.php">
                <input type="text" name="nickname" id="nickname" placeholder="mafe">
                <input type="password" name="password" id="password" placeholder="12345698745236">
                <button>INICIAR SESIÓN</button>
                <p>Si no tienes una cuenta, se creará una automáticamente</p>
            </form>
        </div>
    </div>
